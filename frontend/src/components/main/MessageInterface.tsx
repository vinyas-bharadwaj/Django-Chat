            ...
            <Box sx={{overflow: "hidden", p: {xs: 0}, height: `calc(80vh)`, display: "flex", justifyContent: "center", alignItems: "center"}}>
                            ...
                            {newMessage.map((msg: Message, index: number) => {
                                return (
                                    <ListItem key={index} alignItems="flex-start">
                                        <ListItemAvatar>
                                            <Avatar sx={{height: "40px", width: "40px"}} alt="User Image" />
                                        </ListItemAvatar>
                                        ...
                                        secondary={
                                            <>
                                                <Typography variant="body1" style={{overflow: "visible", whiteSpace: "normal", textOverflow: "clip"}} sx={{display: "inline", lineHeight: 1.2, fontWeight: 400, letterSpacing: "-0.2px"}} color="text.primary" component="span">
                                                    {msg.content}
                                                </Typography>
                                            </>    
                                            }
                ...
                <Box sx={{position: "sticky", bottom: 0, width: "100%"}}>
                    <form onSubmit={handleSubmit} style={{bottom: 0, right: 0, padding: "1rem", backgroundColor: theme.palette.background.default, zIndex: 1}}>
                        <Box sx={{display: "flex"}}>
                            <TextField onKeyDown={handleKeyDown} onChange={(e) => setMessage(e.target.value)} value={message} fullWidth multiline minRows={1} maxRows={4} sx={{flexGrow: 1}} />
                        </Box>
                    </form>
                </Box>
